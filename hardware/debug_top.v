...
module edb_top (
    ...
    output bscan_TDO,
    input  vio0_clk,
    input  [5:0] vio0_q0_ltssm_state,
    input  [1:0] vio0_q0_link_status,
    input  [1:0] vio0_q0_pipe_p00_rate,
    input  vio0_q0_cmn_ready,
    input  [2:0] vio0_q0_TARGET_AXI_AWSIZE,
    input  [63:0] vio0_q0_TARGET_AXI_AWADDR,
    input  [255:0] vio0_q0_TARGET_AXI_WDATA,
    ...
    input  [2:0] la0_q0_TARGET_AXI_AWSIZE,
    input  la0_q0_TARGET_AXI_AWVALID,
    input  [87:0] la0_q0_TARGET_AXI_AWUSER,
    input  [255:0] la0_q0_TARGET_AXI_WDATA,
    input  la0_q0_TARGET_AXI_WVALID,
    input  [31:0] la0_q0_TARGET_AXI_WSTRB,
    input  la0_q0_TARGET_AXI_WLAST,
    input  la0_q0_TARGET_AXI_BREADY,
    input  la0_q0_TARGET_AXI_BVALID,
    input  [1:0] la0_q0_TARGET_AXI_BRESP,
    input  [63:0] la0_q0_TARGET_AXI_ARADDR,
    input  la0_q0_TARGET_AXI_ARVALID,
    input  la0_q0_TARGET_AXI_ARREADY,
    input  [87:0] la0_q0_TARGET_AXI_ARUSER,
    input  [2:0] la0_q0_TARGET_AXI_ARSIZE,
    ...
    input  [63:0] la0_q0_MASTER_AXI_AWADDR,
    ...
    input  la0_q0_MASTER_AXI_BVALID,
    input  [1:0] la0_q0_MASTER_AXI_BRESP,
    input  la0_q0_MASTER_AXI_BREADY,
    input  [7:0] la0_state,
    input  vio1_clk,
    ...
    output vio1_AXI_OPS,
    output vio1_AXI_START,
    output [87:0] vio1_VIO_AXI_AWUSER,
    output vio1_MSI_TEST_INIT,
    input  apbvio_clk,
    input  [31:0] apbvio_apb_prdata,
    output apbvio_apb_write,
    output [23:0] apbvio_apb_paddr,
    output [31:0] apbvio_apb_pwdata,
    output apbvio_apb_start
);
    ...
    wire vio1_module_select;
    wire vio1_module_inhibit;
    wire vio1_module_tdo;

    wire apbvio_module_select;
    wire apbvio_module_inhibit;
    wire apbvio_module_tdo;
    ...
    assign vio1_module_select       = edb_module_selects[2];
    assign edb_module_inhibit[2]    = vio1_module_inhibit;
    assign edb_module_tdo[2]        = vio1_module_tdo;
    assign apbvio_module_select     = edb_module_selects[3];
    assign edb_module_inhibit[3]    = apbvio_module_inhibit;
    assign edb_module_tdo[3]        = apbvio_module_tdo;
    ...
    `DBG_MODULE_NAME(edb_vio_top) #(
        ...
        .clk                ( vio0_clk ),
        .probe_in0          ( vio0_q0_ltssm_state ),
        .probe_in1          ( vio0_q0_link_status ),
        .probe_in2          ( vio0_q0_pipe_p00_rate ),
        .probe_in3          ( vio0_q0_cmn_ready ),
        .probe_in4          ( vio0_q0_TARGET_AXI_AWSIZE ),
        .probe_in5          ( vio0_q0_TARGET_AXI_AWADDR ),
        .probe_in6          ( vio0_q0_TARGET_AXI_WDATA ),
    ...
    `DBG_MODULE_NAME(edb_la_top) #(
        ...
        .trig_out               (  ),
        .trig_out_ack           ( 1'b0 ),
        .probe0                 ( la0_q0_TARGET_AXI_AWADDR ),
        .probe1                 ( la0_q0_TARGET_AXI_AWLEN ),
        .probe2                 ( la0_q0_TARGET_AXI_AWSIZE ),
        .probe3                 ( la0_q0_TARGET_AXI_AWVALID ),
        .probe4                 ( la0_q0_TARGET_AXI_AWUSER ),
        .probe5                 ( la0_q0_TARGET_AXI_WDATA ),
        .probe6                 ( la0_q0_TARGET_AXI_WVALID ),
        .probe7                 ( la0_q0_TARGET_AXI_WSTRB ),
        .probe8                 ( la0_q0_TARGET_AXI_WLAST ),
        .probe9                 ( la0_q0_TARGET_AXI_BREADY ),
        .probe10                    ( la0_q0_TARGET_AXI_BVALID ),
        .probe11                    ( la0_q0_TARGET_AXI_BRESP ),
        .probe12                    ( la0_q0_TARGET_AXI_ARADDR ),
        .probe13                    ( la0_q0_TARGET_AXI_ARVALID ),
        .probe14                    ( la0_q0_TARGET_AXI_ARREADY ),
        .probe15                    ( la0_q0_TARGET_AXI_ARUSER ),
        .probe16                    ( la0_q0_TARGET_AXI_ARSIZE ),
        ...
        .probe21                    ( la0_err_cnt ),
        .probe22                    ( la0_q0_MASTER_AXI_AWADDR ),
    ...
    `DBG_MODULE_NAME(edb_vio_top) #(
        ...
        .PROBE_OUT5_INIT_VAL    ( 'h8000000000000000000002 ),
        ...
        .bscan_UPDATE           ( bscan_UPDATE ),
        .edb_user_dr        ( edb_user_dr ),
        .edb_module_select  ( vio1_module_select  ),
        .edb_module_inhibit ( vio1_module_inhibit ),
        .edb_module_tdo     ( vio1_module_tdo ),
        .edb_soft_reset     ( edb_soft_reset ),
        .clk                ( vio1_clk ),
        ...
        .probe_in62         ( 1'b0 ),
        .probe_in63         ( 1'b0 ),
        .probe_out0         ( vio1_AXI_ADDR ),
        .probe_out1         ( vio1_AXI_DATA ),
        .probe_out2         ( vio1_AXI_WSTRB ),
        .probe_out3         ( vio1_AXI_OPS ),
        .probe_out4         ( vio1_AXI_START ),
        .probe_out5         ( vio1_VIO_AXI_AWUSER ),
        .probe_out6         ( vio1_MSI_TEST_INIT ),
        .probe_out7         (  ),
        .probe_out8         (  ),
        .probe_out9         (  ),
        .probe_out10            (  ),
    ...
    `DBG_MODULE_NAME(edb_vio_top) #(
        ...
        .bscan_UPDATE           ( bscan_UPDATE ),
        .edb_user_dr        ( edb_user_dr ),
        .edb_module_select  ( apbvio_module_select  ),
        .edb_module_inhibit ( apbvio_module_inhibit ),
        .edb_module_tdo     ( apbvio_module_tdo ),
        .edb_soft_reset     ( edb_soft_reset ),
        .clk                ( apbvio_clk ),
        .probe_in0          ( apbvio_apb_prdata ),
        .probe_in1          ( 1'b0 ),
        .probe_in2          ( 1'b0 ),
        .probe_in3          ( 1'b0 ),
        .probe_in4          ( 1'b0 ),
        ...
        .probe_in62         ( 1'b0 ),
        .probe_in63         ( 1'b0 ),
        .probe_out0         ( apbvio_apb_write ),
        .probe_out1         ( apbvio_apb_paddr ),
        .probe_out2         ( apbvio_apb_pwdata ),
        .probe_out3         ( apbvio_apb_start ),
        .probe_out4         (  ),
        .probe_out5         (  ),
        .probe_out6         (  ),
        .probe_out7         (  ),
